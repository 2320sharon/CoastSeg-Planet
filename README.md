...
| raw_transect_time_series.csv   | A csv file containing the shoreline position along the transect for each date and transect id   | Data 4   |
| raw_transect_time_series_merged.csv    | A csv file containing the shoreline position along the transect, the XY point of the shoreline, and the XY point of the seaward point of the transect,  for each date and transect id   | Data 6   |
