...
def test_valid_items(monkeypatch):
    ...
    monkeypatch.setattr('coastseg_planet.download.get_acquired_date', mock_get_acquired_date)
    monkeypatch.setattr('coastseg_planet.download.get_ids_by_date', mock_get_ids_by_date)
